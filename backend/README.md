...
## Project Structure
    ...
    ├── testapiautocatalog_128784  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_128784`
...
2. Clone this repo and `cd testapiautocatalog_128784`
